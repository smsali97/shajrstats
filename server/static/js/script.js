/*Downloaded from https://www.codeseek.co/RandyGarza/multi-level-drill-down-pie-chart-in-d3-eVGqRQ */
...
.then((jdata) => {
    data = jdata;
    show(definitionVisualization,data);
    definitionVisualization.donut.show();
});


function show(visualization,data) {

    visualization.donut = {};

    var topLevelItem = {label: "Pakistan"};
    ...
    var subData = [
        ...
        {colorIndex: 9, value: 5000, children: subSubData, label: "Region 5"}
    ];

    // var data = [
    //     {colorIndex: 0, value: 25, children: subData, label: "Call Center"},
    //     {colorIndex: 1, value: 25, children: subData, label: "Third Party"},
    //     {colorIndex: 2, value: 16.66667, children: subData, label: "Web"},
    //     {colorIndex: 3, value: 16.66667, children: subData, label: "Mobile"},
    //     {colorIndex: 4, value: 16.66667, children: subData, label: "In-Store"}
    // ];
    ...
    function zoomIn(d) {
        ...
        newArc.transition()
            ...
            .each("end", zoomInSweepEnded(d.data.children))
    ...
    function zoomInSweepEnded(children) {
    ...
    function getCurrentItem() {
        ...
        for (var i = 0; i < selectedPath.length; i++) {
            if (i + 1 < selectedPath.length) {
                currentItem = currentItem[selectedPath[i]].children;
            } else {
